...
const string strMessageMagic = "AspectCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    {
        nSubsidy = 1500000 * COIN;   // 1.5M Premine
    }
...
#ifdef ENABLE_WALLET
// aspectcoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("AspectCoin-loadblk");
