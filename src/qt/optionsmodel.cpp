...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeAspectCoinAmount"))
        settings.setValue("nAnonymizeAspectCoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeAspectCoinAmount = settings.value("nAnonymizeAspectCoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeAspectCoinAmount"))
        SoftSetArg("-anonymizeAspectCoinamount", settings.value("nAnonymizeAspectCoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeAspectCoinAmount:
            nAnonymizeAspectCoinAmount = value.toInt();
            settings.setValue("nAnonymizeAspectCoinAmount", nAnonymizeAspectCoinAmount);
            emit anonymizeAspectCoinAmountChanged(nAnonymizeAspectCoinAmount);
            break;
        default:
            break;
        }
